...
export default function Index() {
  ...
  return (
    <View
      ...
      <Text style={styles.subtitle}>Gerador de conselhos amorosos profissional</Text>
      <TextInput
        value={advice}
      ...
      <TouchableOpacity style={styles.button} onPress={handlePress}>
        <Text style={styles.button_text}>{isLoading ? "Carregando ..." : "Gerar conselho infalível!"}</Text>
      </TouchableOpacity>
